...
int buttonState = 1;
const char* serverName = "https://192.168.3.249:89/default";
...
void loop()
{
  ...
  BLEDevice::init("BLE Scanner of Ideaktif");
  ...
  {
     minDeviceStr = "1"; //ALSANCAK
  }
  else if (minMajor==8981 && minMinor==33684)
  {
     minDeviceStr = "2";  //DOKUZ EYLÜL
  }
  ...
  if(WiFi.status()== WL_CONNECTED){
      ...
      String httpRequestData = "{\"PersonId\":3,\"LocationId\":";
      httpRequestData.concat(String(minDeviceStr));
      String httpRequestData3 = ",\"CallTime\":\"06.08.2021\"}";  
      httpRequestData.concat(httpRequestData3);   
      Serial.printf("httpRequestData = %s \n", &httpRequestData);   
