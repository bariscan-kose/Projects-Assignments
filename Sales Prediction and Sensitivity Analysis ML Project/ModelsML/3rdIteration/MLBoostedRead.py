...
drop_features=["Month","Day","ProductName","Barcode","ContentId","Seller","VisualIntegrity","PSF","Keyword","KeywordRank"]
corr_features=["BuyBox","SalesPrice","PurchaseQuantity","Hour","Visit","DiscountRate"]
...
NUMERIC_COLUMNS = ["SalesPrice","Visit","DiscountRate"]
feature_columns=[]
