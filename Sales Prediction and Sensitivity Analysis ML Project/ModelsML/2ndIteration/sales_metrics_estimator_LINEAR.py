...
linear_est = tf.estimator.LinearRegressor(feature_columns=feature_columns, optimizer=tf.keras.optimizers.Ftrl(learning_rate=0.001))
...
plt.scatter(test_labels, test_predictions_Arr)
